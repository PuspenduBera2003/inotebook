...
//       <h2 className='text-center'>Welcome to I-NoteBook ✅!</h2><br />
//       <p>
...
//         Our mission is to empower individuals like you to stay organized, productive, and inspired. We believe that by providing a user-friendly interface and robust features, we can help you streamline your note-taking process and unlock your full potential.<br /><br /></p><hr />

//       <h3>Key Features:</h3><br />

//       <b>1. Personalized Note Storage:</b> Our platform allows you to create and store notes in a secure and private space. Each user has their own dedicated area where they can effortlessly organize their thoughts, tasks, and important information.<br /><br />

//       <b>2. Easy Accessibility:</b> We understand the importance of being able to access your notes anytime, anywhere. Whether you're using your computer, smartphone, or tablet, our website is fully responsive, ensuring a consistent and user-friendly experience across all devices.<br /><br />

//       <b>3. Customization Options:</b> We believe that your note-taking experience should reflect your unique style and preferences. That's why we provide customization options, allowing you to personalize the appearance of your notes and create an environment that inspires you.<br /><br />

//       <b>4. Privacy and Security:</b> We prioritize the privacy and security of your data. Your notes are stored securely, and we employ industry-standard encryption protocols to ensure that your information remains confidential and protected.<br /><br />
...
//         <button type="submit" onClick={RedirectToMail} className="btn btn-primary" >
  ...
  return (
    <div className="container d-flex justify-content-center my-3">
      <Card sx={{ maxWidth: 600 }}>
        <CardHeader
          avatar={
            <Avatar alt="Puspendu Bera" src={devImagePath} />
          }
          action={
        ...
        <Collapse in={expanded} timeout="auto" unmountOnExit>
          <CardContent>
            <Typography paragraph><h5 className='card-title' style={{ fontWeight: 'bold' }}>Key Features:</h5> </Typography>
